...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float text2Width = paint1.measureText(text1);
        float text3Width=paint2.measureText(text2);
        canvas.drawText(text2, 50 + text2Width, 200, paint2);
        canvas.drawText(text3, 50 + text2Width+text3Width, 200, paint1);
    }
}
