    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 第二个： scaleY 从 0 到 1
                // 第三个： alpha 从 0 到 1
                PropertyValuesHolder propertyValuesHolderScaleX=PropertyValuesHolder.ofFloat("scaleX",0,1);
                PropertyValuesHolder propertyValuesHolderScaleY=PropertyValuesHolder.ofFloat("scaleY",0,1);
                PropertyValuesHolder propertyValuesHolderAlpha=PropertyValuesHolder.ofFloat("alpha",0,1);


                // 然后，用 ObjectAnimator.ofPropertyValuesHolder() 把三个属性合并，创建 Animator 然后执行
                ObjectAnimator objectAnimator=ObjectAnimator.ofPropertyValuesHolder(view,propertyValuesHolderScaleX,propertyValuesHolderScaleY,propertyValuesHolderAlpha);
